...
- **문장의 호흡**: 긴 문장과 짧은 문장의 리듬이 장면의 긴장도와 맞는가. 액션에서 긴 만연체, 감정 폭발에서 단문 나열 등 부조화를 잡아낸다.
...
- **추상 의인화**: "침묵이 감돌았다", "두려움이 스며들었다" — 추상 명사가 장면을 대신 끌고 감. 인물의 감각/행동으로 환원 가능한지 진단.
...
- **Talking Head 증후군**: 행동 비트 없이 대사만 5줄 이상 연속되는 구간. 행동 비트, 침묵, 끼어들기, 회피가 필요한 곳을 지적한다.
